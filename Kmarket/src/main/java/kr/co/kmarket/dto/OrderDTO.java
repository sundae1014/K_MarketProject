...
public class OrderDTO {
    ...
    // 회원 정보 조회
    private Integer cust_number;        // 회원 정보(FK)
    ...
    // 결제/포인트 관련
    private Integer payment;            // 결제 수단
    private Integer piece;              // 상품 갯수
    private Integer price;              // 총 결제 가격
    ...
    private Integer stat;               // 주문 상태
    private String etc;             // 기타 정보
    private Integer exchange;           // 반품 여부
