...
public interface ShopMapper {
    ...
    List<MemberDTO> searchAll(@Param("pageRequestDTO") PageRequestDTO pageRequestDTO); //검색 테스트
    int searchCount(@Param("pageRequestDTO") PageRequestDTO pageRequestDTO); //검색 테스트
